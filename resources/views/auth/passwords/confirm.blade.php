                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                data-toggle="tooltip" data-placement="top" title="A senha deve ter mínimo de oito caracteres e mesclar letras maiúsculas e minúsculas, números e caracteres especiais"
